...
const IC = {
  ...
  link: '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>',
...
export function registerAllTools(): void {
  ...
  registerTool({ id: 'assoc', name: '词义联想', icon: IC.link, placeholder: true });
  ...
  /* 占位工具：多分支 / 推演 / 素材库 / 编辑器独立入口 */
  registerTool({ id: 'branch', name: '多分支时间线', icon: '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M6 9v6"/><path d="M18 9c0 3-3 3-6 3"/><path d="M18 15c0-3-3-3-6-3"/></svg>', placeholder: true });
  registerTool({ id: 'simulate', name: '时间线推演', icon: '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>', placeholder: true });
